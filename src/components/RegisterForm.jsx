      ...
      <div className="max-w-2xl mx-auto p-6 bg-(--white) rounded-2xl shadow mb-20 mt-20">
        ...
        <form className="space-y-8">
          <section>
            ...
            <div className="space-y-4">
              ...
              <input
                ...
                className="w-full p-3 bg-(--light-gray-3) text-(--dark-gray-2) border border-transparent focus:ring-0 rounded-lg"
                required
              />
          ...
          <div className="flex items-start">
            ...
            <label htmlFor="ofertas" className="text-sm text-(--dark-gray-2)">
          ...
          <button
            type="submit"
            className="w-full bg-(--primary) text-white py-3 rounded-lg hover:bg-pink-700 transition" /* FIXME: remover bg-pink-700 e usar uma cor em variável */
          >
            Criar Conta
          </button>
        </form>
